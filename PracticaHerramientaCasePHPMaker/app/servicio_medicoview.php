...
$servicio_medico_view = NULL; // Initialize page object first

class cservicio_medico_view extends cservicio_medico {
	...
	// Page object name
	var $PageObjName = 'servicio_medico_view';
	...
	function __construct() {
		...
		if (@$_GET["idservicio_medico"] <> "") {
			$this->RecKey["idservicio_medico"] = $_GET["idservicio_medico"];
			$KeyUrl .= "&amp;idservicio_medico=" . urlencode($this->RecKey["idservicio_medico"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idservicio_medico"] <> "") {
				...
				$this->RecKey["idservicio_medico"] = $this->idservicio_medico->QueryStringValue;
			} else {
				$sReturnUrl = "servicio_medicolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "servicio_medicolist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "servicio_medicolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		$item = &$option->Add("detail_servicio_medico_prestado");
		$body = $Language->Phrase("DetailLink") . $Language->TablePhrase("servicio_medico_prestado", "TblCaption");
		$body = "<a class=\"btn btn-default btn-sm ewRowLink ewDetail\" data-action=\"list\" href=\"" . ew_HtmlEncode("servicio_medico_prestadolist.php?" . EW_TABLE_SHOW_MASTER . "=servicio_medico&fk_idservicio_medico=" . strval($this->idservicio_medico->CurrentValue) . "") . "\">" . $body . "</a>";
		$links = "";
		if ($GLOBALS["servicio_medico_prestado_grid"] && $GLOBALS["servicio_medico_prestado_grid"]->DetailView) {
		...
		if ($GLOBALS["servicio_medico_prestado_grid"] && $GLOBALS["servicio_medico_prestado_grid"]->DetailEdit) {
		...
		if ($GLOBALS["servicio_medico_prestado_grid"] && $GLOBALS["servicio_medico_prestado_grid"]->DetailAdd) {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("servicio_medico_prestado", $DetailTblVar)) {
				...
				if ($GLOBALS["servicio_medico_prestado_grid"]->DetailView) {
					$GLOBALS["servicio_medico_prestado_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($servicio_medico_view)) $servicio_medico_view = new cservicio_medico_view();

// Page init
$servicio_medico_view->Page_Init();

// Page main
$servicio_medico_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$servicio_medico_view->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var servicio_medico_view = new ew_Page("servicio_medico_view");
servicio_medico_view.PageID = "view"; // Page ID
var EW_PAGE_ID = servicio_medico_view.PageID; // For backward compatibility

// Form object
var fservicio_medicoview = new ew_Form("fservicio_medicoview");

// Form_CustomValidate event
fservicio_medicoview.Form_CustomValidate = 
...
fservicio_medicoview.ValidateRequired = true;
<?php } else { ?>
fservicio_medicoview.ValidateRequired = false; 
<?php } ?>
...
<?php $servicio_medico_view->ExportOptions->Render("body") ?>
<?php
	foreach ($servicio_medico_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $servicio_medico_view->ShowPageHeader(); ?>
<?php
$servicio_medico_view->ShowMessage();
?>
<form name="fservicio_medicoview" id="fservicio_medicoview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($servicio_medico_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $servicio_medico_view->Token ?>">
<?php } ?>
...
<?php if ($servicio_medico->idservicio_medico->Visible) { // idservicio_medico ?>
	<tr id="r_idservicio_medico">
		<td><span id="elh_servicio_medico_idservicio_medico"><?php echo $servicio_medico->idservicio_medico->FldCaption() ?></span></td>
		<td<?php echo $servicio_medico->idservicio_medico->CellAttributes() ?>>
<span id="el_servicio_medico_idservicio_medico" class="form-group">
<span<?php echo $servicio_medico->idservicio_medico->ViewAttributes() ?>>
<?php echo $servicio_medico->idservicio_medico->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($servicio_medico->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td><span id="elh_servicio_medico_descripcion"><?php echo $servicio_medico->descripcion->FldCaption() ?></span></td>
...
<?php echo $servicio_medico->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($servicio_medico->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_servicio_medico_estado"><?php echo $servicio_medico->estado->FldCaption() ?></span></td>
...
<?php echo $servicio_medico->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($servicio_medico->es_operacion->Visible) { // es_operacion ?>
	<tr id="r_es_operacion">
		<td><span id="elh_servicio_medico_es_operacion"><?php echo $servicio_medico->es_operacion->FldCaption() ?></span></td>
...
<?php echo $servicio_medico->es_operacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("servicio_medico_prestado", explode(",", $servicio_medico->getCurrentDetailTable())) && $servicio_medico_prestado->DetailView) {
?>
...
<script type="text/javascript">
fservicio_medicoview.Init();
</script>
<?php
$servicio_medico_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$servicio_medico_view->Page_Terminate();
?>
