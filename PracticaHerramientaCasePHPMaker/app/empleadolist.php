...
class cempleado_list extends cempleado {
	...
	function __construct() {
		...
		$this->AddUrl = "empleadoadd.php?" . EW_TABLE_SHOW_DETAIL . "=";
	...
	function SetupListOptions() {
		...
		// "detail_receta"
		$item = &$this->ListOptions->Add("detail_receta");
		$item->CssStyle = "white-space: nowrap;";
	...
	function RenderListOptions() {
		...
		// "detail_receta"
		$oListOpt = &$this->ListOptions->Items["detail_receta"];
		if (TRUE) {
			$body = $Language->Phrase("DetailLink") . $Language->TablePhrase("receta", "TblCaption");
			$body = "<a class=\"btn btn-default btn-sm ewRowLink ewDetail\" data-action=\"list\" href=\"" . ew_HtmlEncode("recetalist.php?" . EW_TABLE_SHOW_MASTER . "=empleado&fk_idempleado=" . strval($this->idempleado->CurrentValue) . "") . "\">" . $body . "</a>";
			$links = "";
	...
	function SetupOtherOptions() {
		...
		$DetailTableLink = "";
		$item = &$option->Add("detailadd_receta");
		$item->Body = "<a class=\"ewDetailAddGroup ewDetailAdd\" title=\"" . ew_HtmlTitle($Language->Phrase("AddMasterDetailLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("AddMasterDetailLink")) . "\" href=\"" . ew_HtmlEncode($this->GetAddUrl() . "?" . EW_TABLE_SHOW_DETAIL . "=receta") . "\">" . $Language->Phrase("Add") . "&nbsp;" . $this->TableCaption() . "/" . $GLOBALS["receta"]->TableCaption() . "</a>";
		$item->Visible = ($GLOBALS["receta"]->DetailAdd);
		if ($item->Visible) {
...
fempleadolist.Lists["x_idhospital"] = {"LinkField":"x_idhospital","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($empleado_list->DbMasterFilter <> "" && $empleado->getCurrentMasterTable() == "hospital") {
...
<?php if ($empleado->idempleado->Visible) { // idempleado ?>
	...
	<?php } else { ?>
		<th data-name="idempleado"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $empleado->SortUrl($empleado->idempleado) ?>',1);"><div id="elh_empleado_idempleado" class="empleado_idempleado">
...
<?php if ($empleado->apellido->Visible) { // apellido ?>
	...
	<?php } else { ?>
		<th data-name="apellido"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $empleado->SortUrl($empleado->apellido) ?>',1);"><div id="elh_empleado_apellido" class="empleado_apellido">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $empleado->apellido->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($empleado->apellido->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($empleado->apellido->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($empleado->cui->Visible) { // cui ?>
	...
	<?php } else { ?>
		<th data-name="cui"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $empleado->SortUrl($empleado->cui) ?>',1);"><div id="elh_empleado_cui" class="empleado_cui">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $empleado->cui->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($empleado->cui->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($empleado->cui->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($empleado->telefono->Visible) { // telefono ?>
	...
	<?php } else { ?>
		<th data-name="telefono"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $empleado->SortUrl($empleado->telefono) ?>',1);"><div id="elh_empleado_telefono" class="empleado_telefono">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $empleado->telefono->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($empleado->telefono->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($empleado->telefono->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($empleado->direccion->Visible) { // direccion ?>
	...
	<?php } else { ?>
		<th data-name="direccion"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $empleado->SortUrl($empleado->direccion) ?>',1);"><div id="elh_empleado_direccion" class="empleado_direccion">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $empleado->direccion->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($empleado->direccion->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($empleado->direccion->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($empleado->idhospital->Visible) { // idhospital ?>
	...
	<?php } else { ?>
		<th data-name="idhospital"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $empleado->SortUrl($empleado->idhospital) ?>',1);"><div id="elh_empleado_idhospital" class="empleado_idhospital">
