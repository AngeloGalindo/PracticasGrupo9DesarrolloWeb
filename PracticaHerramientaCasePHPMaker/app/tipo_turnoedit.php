...
$tipo_turno_edit = NULL; // Initialize page object first

class ctipo_turno_edit extends ctipo_turno {
	...
	// Page object name
	var $PageObjName = 'tipo_turno_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->idtipo_turno->CurrentValue == "")
			$this->Page_Terminate("tipo_turnolist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// horario_inicio
			$this->horario_inicio->SetDbValueDef($rsnew, $this->horario_inicio->CurrentValue, NULL, $this->horario_inicio->ReadOnly);

			// horario_fin
			$this->horario_fin->SetDbValueDef($rsnew, $this->horario_fin->CurrentValue, NULL, $this->horario_fin->ReadOnly);
...
// Create page object
if (!isset($tipo_turno_edit)) $tipo_turno_edit = new ctipo_turno_edit();

// Page init
$tipo_turno_edit->Page_Init();

// Page main
$tipo_turno_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tipo_turno_edit->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var tipo_turno_edit = new ew_Page("tipo_turno_edit");
tipo_turno_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = tipo_turno_edit.PageID; // For backward compatibility

// Form object
var ftipo_turnoedit = new ew_Form("ftipo_turnoedit");

// Validate form
ftipo_turnoedit.Validate = function() {
...
ftipo_turnoedit.Form_CustomValidate = 
...
ftipo_turnoedit.ValidateRequired = true;
<?php } else { ?>
ftipo_turnoedit.ValidateRequired = false; 
<?php } ?>
...
<?php $tipo_turno_edit->ShowPageHeader(); ?>
<?php
$tipo_turno_edit->ShowMessage();
?>
<form name="ftipo_turnoedit" id="ftipo_turnoedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tipo_turno_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tipo_turno_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-field="x_idtipo_turno" name="x_idtipo_turno" id="x_idtipo_turno" value="<?php echo ew_HtmlEncode($tipo_turno->idtipo_turno->CurrentValue) ?>">
<?php
	if (in_array("turno", explode(",", $tipo_turno->getCurrentDetailTable())) && $turno->DetailEdit) {
?>
...
<script type="text/javascript">
ftipo_turnoedit.Init();
</script>
<?php
$tipo_turno_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tipo_turno_edit->Page_Terminate();
?>
