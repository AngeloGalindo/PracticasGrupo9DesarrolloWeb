...
$doctor_view = NULL; // Initialize page object first

class cdoctor_view extends cdoctor {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["iddoctor"] <> "") {
			$this->RecKey["iddoctor"] = $_GET["iddoctor"];
			$KeyUrl .= "&amp;iddoctor=" . urlencode($this->RecKey["iddoctor"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["iddoctor"] <> "") {
				...
				$this->RecKey["iddoctor"] = $this->iddoctor->QueryStringValue;
			} else {
				$sReturnUrl = "doctorlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "doctorlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "doctorlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		// "detail_consulta"
		$item = &$option->Add("detail_consulta");
		...
		$links = "";
		if ($GLOBALS["consulta_grid"] && $GLOBALS["consulta_grid"]->DetailView) {
		...
		if ($GLOBALS["consulta_grid"] && $GLOBALS["consulta_grid"]->DetailEdit) {
		...
		if ($GLOBALS["consulta_grid"] && $GLOBALS["consulta_grid"]->DetailAdd) {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("consulta", $DetailTblVar)) {
				...
				if ($GLOBALS["consulta_grid"]->DetailView) {
					$GLOBALS["consulta_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($doctor_view)) $doctor_view = new cdoctor_view();

// Page init
$doctor_view->Page_Init();

// Page main
$doctor_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$doctor_view->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var doctor_view = new ew_Page("doctor_view");
doctor_view.PageID = "view"; // Page ID
var EW_PAGE_ID = doctor_view.PageID; // For backward compatibility

// Form object
var fdoctorview = new ew_Form("fdoctorview");

// Form_CustomValidate event
fdoctorview.Form_CustomValidate = 
...
fdoctorview.ValidateRequired = true;
<?php } else { ?>
fdoctorview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdoctorview.Lists["x_idturno"] = {"LinkField":"x_idturno","Ajax":true,"AutoFill":false,"DisplayFields":["x_descripcion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $doctor_view->ExportOptions->Render("body") ?>
<?php
	foreach ($doctor_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $doctor_view->ShowPageHeader(); ?>
<?php
$doctor_view->ShowMessage();
?>
<form name="fdoctorview" id="fdoctorview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($doctor_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $doctor_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="doctor">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($doctor->iddoctor->Visible) { // iddoctor ?>
	<tr id="r_iddoctor">
		<td><span id="elh_doctor_iddoctor"><?php echo $doctor->iddoctor->FldCaption() ?></span></td>
		<td<?php echo $doctor->iddoctor->CellAttributes() ?>>
<span id="el_doctor_iddoctor" class="form-group">
<span<?php echo $doctor->iddoctor->ViewAttributes() ?>>
<?php echo $doctor->iddoctor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($doctor->nombre->Visible) { // nombre ?>
	<tr id="r_nombre">
		<td><span id="elh_doctor_nombre"><?php echo $doctor->nombre->FldCaption() ?></span></td>
...
<?php echo $doctor->nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($doctor->apellido->Visible) { // apellido ?>
	<tr id="r_apellido">
		<td><span id="elh_doctor_apellido"><?php echo $doctor->apellido->FldCaption() ?></span></td>
...
<?php echo $doctor->apellido->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($doctor->telefono->Visible) { // telefono ?>
	<tr id="r_telefono">
		<td><span id="elh_doctor_telefono"><?php echo $doctor->telefono->FldCaption() ?></span></td>
...
<?php echo $doctor->telefono->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($doctor->direccion->Visible) { // direccion ?>
	<tr id="r_direccion">
		<td><span id="elh_doctor_direccion"><?php echo $doctor->direccion->FldCaption() ?></span></td>
...
<?php echo $doctor->direccion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($doctor->idturno->Visible) { // idturno ?>
	<tr id="r_idturno">
		<td><span id="elh_doctor_idturno"><?php echo $doctor->idturno->FldCaption() ?></span></td>
...
<?php echo $doctor->idturno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($doctor->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_doctor_estado"><?php echo $doctor->estado->FldCaption() ?></span></td>
...
<?php echo $doctor->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("consulta", explode(",", $doctor->getCurrentDetailTable())) && $consulta->DetailView) {
?>
