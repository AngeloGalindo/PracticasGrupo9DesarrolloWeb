...
fcuentalist.Lists["x_idpaciente"] = {"LinkField":"x_idpaciente","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($cuenta_list->DbMasterFilter <> "" && $cuenta->getCurrentMasterTable() == "paciente") {
...
<?php if ($cuenta->idpaciente->Visible) { // idpaciente ?>
	...
	<?php } else { ?>
		<th data-name="idpaciente"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cuenta->SortUrl($cuenta->idpaciente) ?>',1);"><div id="elh_cuenta_idpaciente" class="cuenta_idpaciente">
...
<?php if ($cuenta->fecha_inicio->Visible) { // fecha_inicio ?>
	...
	<?php } else { ?>
		<th data-name="fecha_inicio"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cuenta->SortUrl($cuenta->fecha_inicio) ?>',1);"><div id="elh_cuenta_fecha_inicio" class="cuenta_fecha_inicio">
...
<?php if ($cuenta->fecha_final->Visible) { // fecha_final ?>
	...
	<?php } else { ?>
		<th data-name="fecha_final"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cuenta->SortUrl($cuenta->fecha_final) ?>',1);"><div id="elh_cuenta_fecha_final" class="cuenta_fecha_final">
