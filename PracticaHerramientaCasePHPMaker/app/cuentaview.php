...
fcuentaview.Lists["x_idpaciente"] = {"LinkField":"x_idpaciente","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($cuenta->idpaciente->Visible) { // idpaciente ?>
	<tr id="r_idpaciente">
		<td><span id="elh_cuenta_idpaciente"><?php echo $cuenta->idpaciente->FldCaption() ?></span></td>
...
<?php echo $cuenta->idpaciente->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cuenta->fecha_inicio->Visible) { // fecha_inicio ?>
	<tr id="r_fecha_inicio">
		<td><span id="elh_cuenta_fecha_inicio"><?php echo $cuenta->fecha_inicio->FldCaption() ?></span></td>
...
<?php echo $cuenta->fecha_inicio->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cuenta->fecha_final->Visible) { // fecha_final ?>
	<tr id="r_fecha_final">
		<td><span id="elh_cuenta_fecha_final"><?php echo $cuenta->fecha_final->FldCaption() ?></span></td>
...
<?php echo $cuenta->fecha_final->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("servicio_medico_prestado", explode(",", $cuenta->getCurrentDetailTable())) && $servicio_medico_prestado->DetailView) {
?>
...
<?php } ?>
<?php
	if (in_array("consulta", explode(",", $cuenta->getCurrentDetailTable())) && $consulta->DetailView) {
?>
<?php if ($cuenta->getCurrentDetailTable() <> "") { ?>
...
<?php } ?>
<?php
	if (in_array("internado_diario", explode(",", $cuenta->getCurrentDetailTable())) && $internado_diario->DetailView) {
?>
<?php if ($cuenta->getCurrentDetailTable() <> "") { ?>
