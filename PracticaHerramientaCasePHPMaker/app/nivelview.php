...
$nivel_view = NULL; // Initialize page object first

class cnivel_view extends cnivel {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idnivel"] <> "") {
				...
				$sReturnUrl = "nivellist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "nivellist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "nivellist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		$links = "";
		if ($GLOBALS["sala_grid"] && $GLOBALS["sala_grid"]->DetailView) {
		...
		if ($GLOBALS["sala_grid"] && $GLOBALS["sala_grid"]->DetailEdit) {
		...
		if ($GLOBALS["sala_grid"] && $GLOBALS["sala_grid"]->DetailAdd) {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("sala", $DetailTblVar)) {
				...
				if ($GLOBALS["sala_grid"]->DetailView) {
					$GLOBALS["sala_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($nivel_view)) $nivel_view = new cnivel_view();

// Page init
$nivel_view->Page_Init();

// Page main
$nivel_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$nivel_view->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var nivel_view = new ew_Page("nivel_view");
nivel_view.PageID = "view"; // Page ID
var EW_PAGE_ID = nivel_view.PageID; // For backward compatibility

// Form object
var fnivelview = new ew_Form("fnivelview");

// Form_CustomValidate event
fnivelview.Form_CustomValidate = 
...
fnivelview.ValidateRequired = true;
<?php } else { ?>
fnivelview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fnivelview.Lists["x_idhospital"] = {"LinkField":"x_idhospital","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $nivel_view->ExportOptions->Render("body") ?>
<?php
	foreach ($nivel_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $nivel_view->ShowPageHeader(); ?>
<?php
$nivel_view->ShowMessage();
?>
<form name="fnivelview" id="fnivelview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($nivel_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $nivel_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="nivel">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($nivel->idnivel->Visible) { // idnivel ?>
	<tr id="r_idnivel">
		<td><span id="elh_nivel_idnivel"><?php echo $nivel->idnivel->FldCaption() ?></span></td>
		<td<?php echo $nivel->idnivel->CellAttributes() ?>>
<span id="el_nivel_idnivel" class="form-group">
<span<?php echo $nivel->idnivel->ViewAttributes() ?>>
<?php echo $nivel->idnivel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($nivel->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td><span id="elh_nivel_descripcion"><?php echo $nivel->descripcion->FldCaption() ?></span></td>
...
<?php echo $nivel->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($nivel->idhospital->Visible) { // idhospital ?>
	<tr id="r_idhospital">
		<td><span id="elh_nivel_idhospital"><?php echo $nivel->idhospital->FldCaption() ?></span></td>
...
<?php echo $nivel->idhospital->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("sala", explode(",", $nivel->getCurrentDetailTable())) && $sala->DetailView) {
?>
