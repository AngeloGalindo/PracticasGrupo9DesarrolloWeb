...
// Form object
var fdepartamentoedit = new ew_Form("fdepartamentoedit");
...
fdepartamentoedit.Lists["x_idpais"] = {"LinkField":"x_idpais","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fdepartamentoedit" id="fdepartamentoedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($departamento->estado->Visible) { // estado ?>
	<div id="r_estado" class="form-group">
		<label id="elh_departamento_estado" class="col-sm-2 control-label ewLabel"><?php echo $departamento->estado->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
if (is_array($arwrk)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($departamento->estado->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
