...
define("EW_PROJECT_NAME", "hospital", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{C2CC4043-40A3-40C7-9AE6-B21670F505A9}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'dI82KizNo7fIPcfp', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/hospital.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", 'nexthor_hospital', TRUE);
