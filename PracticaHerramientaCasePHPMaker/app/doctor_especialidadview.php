...
$doctor_especialidad_view = NULL; // Initialize page object first

class cdoctor_especialidad_view extends cdoctor_especialidad {
	...
	// Page object name
	var $PageObjName = 'doctor_especialidad_view';
	...
	function __construct() {
		...
		if (@$_GET["iddoctor_especialidad"] <> "") {
			$this->RecKey["iddoctor_especialidad"] = $_GET["iddoctor_especialidad"];
			$KeyUrl .= "&amp;iddoctor_especialidad=" . urlencode($this->RecKey["iddoctor_especialidad"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["iddoctor_especialidad"] <> "") {
				...
				$this->RecKey["iddoctor_especialidad"] = $this->iddoctor_especialidad->QueryStringValue;
			} else {
				$sReturnUrl = "doctor_especialidadlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "doctor_especialidadlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "doctor_especialidadlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($doctor_especialidad_view)) $doctor_especialidad_view = new cdoctor_especialidad_view();

// Page init
$doctor_especialidad_view->Page_Init();

// Page main
$doctor_especialidad_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$doctor_especialidad_view->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var doctor_especialidad_view = new ew_Page("doctor_especialidad_view");
doctor_especialidad_view.PageID = "view"; // Page ID
var EW_PAGE_ID = doctor_especialidad_view.PageID; // For backward compatibility

// Form object
var fdoctor_especialidadview = new ew_Form("fdoctor_especialidadview");

// Form_CustomValidate event
fdoctor_especialidadview.Form_CustomValidate = 
...
fdoctor_especialidadview.ValidateRequired = true;
<?php } else { ?>
fdoctor_especialidadview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdoctor_especialidadview.Lists["x_iddoctor"] = {"LinkField":"x_iddoctor","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","x_apellido",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fdoctor_especialidadview.Lists["x_idespecialidad"] = {"LinkField":"x_idespecialidad","Ajax":true,"AutoFill":false,"DisplayFields":["x_descripcion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $doctor_especialidad_view->ExportOptions->Render("body") ?>
<?php
	foreach ($doctor_especialidad_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $doctor_especialidad_view->ShowPageHeader(); ?>
<?php
$doctor_especialidad_view->ShowMessage();
?>
<form name="fdoctor_especialidadview" id="fdoctor_especialidadview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($doctor_especialidad_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $doctor_especialidad_view->Token ?>">
<?php } ?>
...
<?php if ($doctor_especialidad->iddoctor_especialidad->Visible) { // iddoctor_especialidad ?>
	<tr id="r_iddoctor_especialidad">
		<td><span id="elh_doctor_especialidad_iddoctor_especialidad"><?php echo $doctor_especialidad->iddoctor_especialidad->FldCaption() ?></span></td>
...
<?php echo $doctor_especialidad->iddoctor_especialidad->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($doctor_especialidad->iddoctor->Visible) { // iddoctor ?>
	<tr id="r_iddoctor">
		<td><span id="elh_doctor_especialidad_iddoctor"><?php echo $doctor_especialidad->iddoctor->FldCaption() ?></span></td>
...
<?php echo $doctor_especialidad->iddoctor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($doctor_especialidad->idespecialidad->Visible) { // idespecialidad ?>
	<tr id="r_idespecialidad">
		<td><span id="elh_doctor_especialidad_idespecialidad"><?php echo $doctor_especialidad->idespecialidad->FldCaption() ?></span></td>
...
<?php echo $doctor_especialidad->idespecialidad->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("doctor", explode(",", $doctor_especialidad->getCurrentDetailTable())) && $doctor->DetailView) {
?>
...
<script type="text/javascript">
fdoctor_especialidadview.Init();
</script>
<?php
$doctor_especialidad_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$doctor_especialidad_view->Page_Terminate();
?>
