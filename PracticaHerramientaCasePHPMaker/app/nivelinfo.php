...
//
// Table class for nivel
//
class cnivel extends cTable {
	var $idnivel;
	var $descripcion;
	var $estado;
	var $idhospital;
	...
	function __construct() {
		...
		// idnivel
		$this->idnivel = new cField('nivel', 'nivel', 'x_idnivel', 'idnivel', '`idnivel`', '`idnivel`', 3, -1, FALSE, '`idnivel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->idnivel->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['idnivel'] = &$this->idnivel;

		// descripcion
		$this->descripcion = new cField('nivel', 'nivel', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 200, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['descripcion'] = &$this->descripcion;

		// estado
		$this->estado = new cField('nivel', 'nivel', 'x_estado', 'estado', '`estado`', '`estado`', 202, -1, FALSE, '`estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['estado'] = &$this->estado;

		// idhospital
		$this->idhospital = new cField('nivel', 'nivel', 'x_idhospital', 'idhospital', '`idhospital`', '`idhospital`', 3, -1, FALSE, '`idhospital`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "sala") {
			$sDetailUrl = $GLOBALS["sala"]->GetListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&fk_idnivel=" . urlencode($this->idnivel->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "nivellist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`nivel`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("nivelview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("nivelview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "niveladd.php?" . $this->UrlParm($parm);
		else
			return "niveladd.php";
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("niveledit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("niveledit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("niveladd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("niveladd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("niveldelete.php", $this->UrlParm());
	}
