...
fempleadoview.Lists["x_idhospital"] = {"LinkField":"x_idhospital","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($empleado->telefono->Visible) { // telefono ?>
	<tr id="r_telefono">
		<td><span id="elh_empleado_telefono"><?php echo $empleado->telefono->FldCaption() ?></span></td>
...
<?php echo $empleado->telefono->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($empleado->idhospital->Visible) { // idhospital ?>
	<tr id="r_idhospital">
		<td><span id="elh_empleado_idhospital"><?php echo $empleado->idhospital->FldCaption() ?></span></td>
...
<?php echo $empleado->idhospital->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("receta", explode(",", $empleado->getCurrentDetailTable())) && $receta->DetailView) {
?>
