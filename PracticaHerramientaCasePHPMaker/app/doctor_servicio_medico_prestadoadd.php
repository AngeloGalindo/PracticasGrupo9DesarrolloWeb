...
$doctor_servicio_medico_prestado_add = NULL; // Initialize page object first

class cdoctor_servicio_medico_prestado_add extends cdoctor_servicio_medico_prestado {
	...
	// Page object name
	var $PageObjName = 'doctor_servicio_medico_prestado_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["iddoctor_servicio_medico_prestado"] != "") {
				...
				$this->setKey("iddoctor_servicio_medico_prestado", $this->iddoctor_servicio_medico_prestado->CurrentValue); // Set up key
			} else {
				$this->setKey("iddoctor_servicio_medico_prestado", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "doctor_servicio_medico_prestadoview.php")
	...
	function LoadDefaultValues() {
		...
		$this->idservicio_medico_prestado->CurrentValue = 1;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// idservicio_medico_prestado
		$this->idservicio_medico_prestado->SetDbValueDef($rsnew, $this->idservicio_medico_prestado->CurrentValue, 0, strval($this->idservicio_medico_prestado->CurrentValue) == "");
		...
		if ($AddRow) {
			$this->iddoctor_servicio_medico_prestado->setDbValue($conn->Insert_ID());
			$rsnew['iddoctor_servicio_medico_prestado'] = $this->iddoctor_servicio_medico_prestado->DbValue;
		}
		if ($AddRow) {
...
// Create page object
if (!isset($doctor_servicio_medico_prestado_add)) $doctor_servicio_medico_prestado_add = new cdoctor_servicio_medico_prestado_add();

// Page init
$doctor_servicio_medico_prestado_add->Page_Init();

// Page main
$doctor_servicio_medico_prestado_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$doctor_servicio_medico_prestado_add->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var doctor_servicio_medico_prestado_add = new ew_Page("doctor_servicio_medico_prestado_add");
doctor_servicio_medico_prestado_add.PageID = "add"; // Page ID
var EW_PAGE_ID = doctor_servicio_medico_prestado_add.PageID; // For backward compatibility

// Form object
var fdoctor_servicio_medico_prestadoadd = new ew_Form("fdoctor_servicio_medico_prestadoadd");

// Validate form
fdoctor_servicio_medico_prestadoadd.Validate = function() {
...
fdoctor_servicio_medico_prestadoadd.Form_CustomValidate = 
...
fdoctor_servicio_medico_prestadoadd.ValidateRequired = true;
<?php } else { ?>
fdoctor_servicio_medico_prestadoadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdoctor_servicio_medico_prestadoadd.Lists["x_iddoctor"] = {"LinkField":"x_iddoctor","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","x_apellido",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fdoctor_servicio_medico_prestadoadd.Lists["x_idservicio_medico_prestado"] = {"LinkField":"x_idservicio_medico_prestado","Ajax":true,"AutoFill":false,"DisplayFields":["x_idservicio_medico_prestado","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $doctor_servicio_medico_prestado_add->ShowPageHeader(); ?>
<?php
$doctor_servicio_medico_prestado_add->ShowMessage();
?>
<form name="fdoctor_servicio_medico_prestadoadd" id="fdoctor_servicio_medico_prestadoadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($doctor_servicio_medico_prestado_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $doctor_servicio_medico_prestado_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fdoctor_servicio_medico_prestadoadd.CreateAutoSuggest("x_idservicio_medico_prestado", true);
</script>
</span>
<?php } ?>
...
<script type="text/javascript">
fdoctor_servicio_medico_prestadoadd.Init();
</script>
<?php
$doctor_servicio_medico_prestado_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$doctor_servicio_medico_prestado_add->Page_Terminate();
?>
