...
?>
<form name="fdepartamentodelete" id="fdepartamentodelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($departamento_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $departamento_delete->Token ?>">
<?php } ?>
...
<?php if ($departamento->iddepartamento->Visible) { // iddepartamento ?>
		<th><span id="elh_departamento_iddepartamento" class="departamento_iddepartamento"><?php echo $departamento->iddepartamento->FldCaption() ?></span></th>
<?php } ?>
<?php if ($departamento->nombre->Visible) { // nombre ?>
		<th><span id="elh_departamento_nombre" class="departamento_nombre"><?php echo $departamento->nombre->FldCaption() ?></span></th>
<?php } ?>
<?php if ($departamento->estado->Visible) { // estado ?>
		<th><span id="elh_departamento_estado" class="departamento_estado"><?php echo $departamento->estado->FldCaption() ?></span></th>
<?php } ?>
<?php if ($departamento->idpais->Visible) { // idpais ?>
		<th><span id="elh_departamento_idpais" class="departamento_idpais"><?php echo $departamento->idpais->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_iddepartamento" class="form-group departamento_iddepartamento">
<span<?php echo $departamento->iddepartamento->ViewAttributes() ?>>
<?php echo $departamento->iddepartamento->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($departamento->nombre->Visible) { // nombre ?>
		<td<?php echo $departamento->nombre->CellAttributes() ?>>
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_nombre" class="form-group departamento_nombre">
...
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_estado" class="form-group departamento_estado">
...
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_idpais" class="form-group departamento_idpais">
