...
$internado_diario_edit = NULL; // Initialize page object first

class cinternado_diario_edit extends cinternado_diario {
	...
	// Page object name
	var $PageObjName = 'internado_diario_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->idinternado_diario->CurrentValue == "")
			$this->Page_Terminate("internado_diariolist.php"); // Invalid key, return to list
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->idinternado_diario->FldIsDetailKey)
			$this->idinternado_diario->setFormValue($objForm->GetValue("x_idinternado_diario"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->idinternado_diario->CurrentValue = $this->idinternado_diario->FormValue;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// idinternado
			$this->idinternado->SetDbValueDef($rsnew, $this->idinternado->CurrentValue, 0, $this->idinternado->ReadOnly);
...
// Create page object
if (!isset($internado_diario_edit)) $internado_diario_edit = new cinternado_diario_edit();

// Page init
$internado_diario_edit->Page_Init();

// Page main
$internado_diario_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$internado_diario_edit->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var internado_diario_edit = new ew_Page("internado_diario_edit");
internado_diario_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = internado_diario_edit.PageID; // For backward compatibility

// Form object
var finternado_diarioedit = new ew_Form("finternado_diarioedit");

// Validate form
finternado_diarioedit.Validate = function() {
...
finternado_diarioedit.Form_CustomValidate = 
...
finternado_diarioedit.ValidateRequired = true;
<?php } else { ?>
finternado_diarioedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
finternado_diarioedit.Lists["x_idinternado"] = {"LinkField":"x_idinternado","Ajax":true,"AutoFill":false,"DisplayFields":["x_idinternado","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
finternado_diarioedit.Lists["x_idcuenta"] = {"LinkField":"x_idcuenta","Ajax":true,"AutoFill":false,"DisplayFields":["x_idcuenta","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $internado_diario_edit->ShowPageHeader(); ?>
<?php
$internado_diario_edit->ShowMessage();
?>
<form name="finternado_diarioedit" id="finternado_diarioedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($internado_diario_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $internado_diario_edit->Token ?>">
<?php } ?>
...
<?php if ($internado_diario->idinternado_diario->Visible) { // idinternado_diario ?>
	<div id="r_idinternado_diario" class="form-group">
		<label id="elh_internado_diario_idinternado_diario" class="col-sm-2 control-label ewLabel"><?php echo $internado_diario->idinternado_diario->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $internado_diario->idinternado_diario->CellAttributes() ?>>
<span id="el_internado_diario_idinternado_diario">
...
<input type="hidden" data-field="x_idinternado_diario" name="x_idinternado_diario" id="x_idinternado_diario" value="<?php echo ew_HtmlEncode($internado_diario->idinternado_diario->CurrentValue) ?>">
<?php echo $internado_diario->idinternado_diario->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("finternado_diarioedit", "x_fecha", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
finternado_diarioedit.Init();
</script>
<?php
$internado_diario_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$internado_diario_edit->Page_Terminate();
?>
