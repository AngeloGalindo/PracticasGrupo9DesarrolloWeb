...
define("EW_PROJECT_NAME", "store_test", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{34F088E4-E55C-4BE8-A022-381A83ECD455}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '2034xJ15T90b5y7I', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/store_test.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", 'proceso', TRUE);
define("EW_CONN_PASS", 'nd', TRUE);
define("EW_CONN_DB", 'sales', TRUE);
