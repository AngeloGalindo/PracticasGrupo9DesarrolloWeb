...
// :digits -> sólo números
// :number-> un número válido
// :length;x -> tiene que tener x caracteres.
// :min_length;x -> mínimo x caracteres.
// :max_length;n -> máximo x caracteres.
// :accept -> debe ser aceptado(check).
// :email -> comprobar email.
// :format;n -> expresión regular n
// :date -> fecha válida
// :date_au -> formato de fecha: dd/mm/aaaa
// :url -> URL válida
// :alphanum -> letras (a-z) y números (0-9)
// :asciialpha -> letras ASCII (a-z)
// :alpha -> sólo letras
